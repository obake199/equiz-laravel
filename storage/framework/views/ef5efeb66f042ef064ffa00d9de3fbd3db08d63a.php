    ...
    <nav class="py-3 navbar navbar-expand-lg fixed-top auto-hiding-navbar bg-light">
    	<div class="container-fluid">
        	<a class="navbar-brand">
          		<img src="<?php echo e(asset('img/homepage/logo_equiz_no_text.png')); ?>">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col img-col">
					<img src=<?php echo e(asset("/img/homepage/hero-img.png")); ?> class="img-fluid" alt="Software Development" style="width:400px;">
				</div>
			</div>
	...
	<section id="about-us">
		<div class="container">
			<div class="row align-items-center">
          		<div class="col">
              		<img src="<?php echo e(asset('img/homepage/about-us.png')); ?>" class="img-fluid" alt="About Us">
          		</div>
...
</style><?php /**PATH C:\laragon\www\equiz-laravel\resources\views/welcome.blade.php ENDPATH**/ ?>